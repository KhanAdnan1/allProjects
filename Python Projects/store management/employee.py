...
class employeeclass:
    def __init__(self,root):
        ...
        #===searchFrame=====
        # SearchFrame=LabelFrame(self.root,text="Search Employee",font=("goudy old style",12,"bold"),bd=2,relief=RIDGE,bg="#fafafa")
        ...
        # btn_search=Button(SearchFrame,text="Search",command=self.search,font=("goudy old style",15),bg="steelblue",fg="white",cursor="hand2").place(x=410,y=9,width=150,height=30)

        #===title====
        title=Label(self.root,text="Employee Details",font=("goudy old style",20),bg="#2a2f4f",fg="white").place(x=0,y=0,width=1100,height=40)
        ...
        btn_add=Button(self.root,text="Save",command=self.add,font=("goudy old style",15),bg="violet",fg="white",cursor="hand2").place(x=300,y=250,width=110,height=40)
        btn_update=Button(self.root,text="Update",command=self.update,font=("goudy old style",15),bg="teal",fg="white",cursor="hand2").place(x=420,y=250,width=110,height=40)
        btn_delete=Button(self.root,text="Delete",command=self.delete,font=("goudy old style",15),bg="coral",fg="white",cursor="hand2").place(x=540,y=250,width=110,height=40)
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("goudy old style",15),bg="red",fg="white",cursor="hand2").place(x=660,y=250,width=110,height=40)
